...
class DatabaseHelper {
  ...
  String colUserExtraInfo = 'extraInfo';
  ...
  void _createDb(Database db, int version) async {
    ...
    await db.execute(
        'CREATE TABLE $userTable($colUserId TEXT PRIMARY KEY, $colUserName TEXT NOT NULL ,$colUserAge INTEGER NOT NULL, $colUserGender INTEGER NOT NULL, $colUserIsMe INTEGER NOT NULL ,$colUserExtraInfo TEXT NOT NULL, $colCreatedAt INTEGER NOT NULL, $colUpdateAt INTEGER NOT NULL)');
    await db.execute(
