      ...
      body: Column(
        children: conversations
            .map((conversation) => ListTile(
                  ...
                  subtitle: Text(conversation.messages.length > 1
...
Message message1 = Message(id: 1, message: 'Message1', sender: user1);
Message message2 = Message(id: 2, message: 'Message2', sender: user2);
Message message3 = Message(id: 3, message: 'Message3', sender: user3);
